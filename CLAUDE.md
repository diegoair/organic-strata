...
- **Typography** — **Manrope only**, via `--font` from `shared/organica-tokens.css`. Never add a second typeface or hardcode a `font-size`; use a scale step or add one. Full system + Figma mapping: `docs/DESIGN-SYSTEM.md`
