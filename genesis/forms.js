// Base Seed SVG templates. 13 curated static forms — the organic half of
// Genesis's "Base Seeds" set (the other 6 are procedural primitives,
// synthesised in genesis/index.html). Keyed by their historical numeric id
// (stable — downstream tools reference forms by number). The `class="aNN"`
// hooks are retained for the hub bento's animated preview only; Genesis
// itself renders these static (animation:none) and no longer links
// animations.css. A deeper restructure (slug keys, per-form metadata,
// dropping the class hooks) is a tracked follow-up — see docs/ROADMAP.md.
window.ORGANIC_FORMS = {
  ...
  56: `<svg viewBox="0 0 200 200" class="a56"><line x1="36" y1="100" x2="164" y2="100" stroke="currentColor" stroke-width="10" stroke-linecap="round"/></svg>`,
};
window.ORGANIC_LABELS = {
  "1": "breath", "2": "heartbeat", "3": "metaballs", "7": "drop fall",
  "9": "lava detach", "13": "flower bloom", "14": "petal turn",
  "21": "caterpillar", "26": "amoeba", "28": "mitosis", "37": "sun",
  "41": "bubble cluster", "56": "line",
};
